...
//        builder.setTitle("Confirm Request");
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                sendNotification(itemUploaderId, "Claim Request", "Someone has requested to claim the item you uploaded.", requestClaimId, currentDate);
                                                sendNotification(currentUserId, "Successfully sent a request", "Your claim request has been sent successfully.", requestClaimId, currentDate);
    ...
    private void sendNotification(String userId, String title, String message, String requestClaimId, String date) {
        ...
        Notification notification = new Notification(title, message, date, requestClaimId);
